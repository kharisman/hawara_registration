    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{ url('/home/blog') }}">Blog</a></li>
	...
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<form action="{{ url('home/blogs/create') }}" method="post" enctype="multipart/form-data">
							{{ csrf_field() }}
							...
							<div class="form-group">
								<label>Title</label>
								<input type="text" name="blog_title" class="form-control @if($errors->first('blog_title')) is-invalid @endif" autofocus="" value="{{ old('blog_title') }}" autocomplete="off" placeholder="Input Title">
							...
							<div class="form-group">
								...
								<select name="tags[]" class="form-control select2" multiple="multiple" style="width: 100%;">
									@foreach($tag as $t)
									<option value="{{ $t->uid }}">{{ $t->tag_name }}</option>
									@endforeach
								</select>
