	...
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-6">
				<div class="card">
					<div class="card-body">
						<form action="{{ url('home/Merchant/create') }}" method="post" enctype="multipart/form-data">
							{{ csrf_field() }}
							<div class="form-group">
								<label>Nama Merchant</label>
								<input type="text" name="name" class="form-control @if($errors->first('name')) is-invalid @endif" autofocus="" value="{{ old('name') }}" autocomplete="off" placeholder="Input Nama Merchant">
