				...
				<div class="card">
					<div class="card-body">
						<form action="{{ url('home/banners/create') }}" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label>Title</label>
								<input type="text" name="gimmick_title" class="form-control @if($errors->first('gimmick_title')) is-invalid @endif" autofocus="" value="{{ old('gimmick_title') }}" autocomplete="off" placeholder="Input Title">
